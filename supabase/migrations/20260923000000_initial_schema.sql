-- BudgetMirror AI — initial migration (MVP + stretch tables)
-- This frozen baseline lets Supabase Preview create a database from scratch before
-- applying the later admin/RLS hotfix migrations. Keep supabase/schema.sql as the
-- convenient idempotent SQL Editor bootstrap for manually managed projects.
